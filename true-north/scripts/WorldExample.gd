...
export (int) var view_distance = 256 setget set_view_distance
...
export (int) var height = 64 setget set_height
func set_height(val):
	_clear()
	height = val
	_initialize()

export (float) var height_bias = 0.75 setget set_height_bias
...
export (float) var period = 84.0 setget set_period
func set_period(val):
	_clear()
	period = val
	_initialize()
...
export (float) var persistence = 0.4 setget set_persistence
